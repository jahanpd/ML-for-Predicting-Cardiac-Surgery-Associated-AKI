...
# gsearch.fit(scaler.transform(data.values), y.values)
# clf = gsearch.best_estimator_
# pd.DataFrame(gsearch.cv_results_).to_csv("output/LRfull.csv")
#
# output = cross_validate(clf, scaler.transform(data.values), y.values, scoring=metrics,cv=rkf,  verbose=2,return_train_score=True)
# pd.DataFrame(output).to_csv('output/performanceLRfull.csv')
#
#
...
clf = gsearch.best_estimator_
pd.DataFrame(gsearch.cv_results_).to_csv("output/RFfull.csv")

output = cross_validate(clf, data.values, y.values, scoring=metrics,cv=rkf,  verbose=2,return_train_score=True)
pd.DataFrame(output).to_csv('output/performanceRFfull.csv')
...
gsearch.fit(data.values, y.values)
clf = gsearch.best_estimator_
pd.DataFrame(gsearch.cv_results_).to_csv("output/DTfull.csv")

output = cross_validate(clf, data.values, y.values, scoring=metrics,cv=rkf,  verbose=2,return_train_score=True)
pd.DataFrame(output).to_csv('output/performanceDTfull.csv')
...
gsearch.fit(data.values, y.values)
clf = gsearch.best_estimator_
pd.DataFrame(gsearch.cv_results_).to_csv("output/GBfull.csv")

output = cross_validate(clf, data.values, y.values, scoring=metrics,cv=rkf,  verbose=2,return_train_score=True)
pd.DataFrame(output).to_csv('output/performanceXGBfull.csv')
...
gsearch.fit(data.values, y.values)
clf = gsearch.best_estimator_
pd.DataFrame(gsearch.cv_results_).to_csv("output/KNNfull.csv")

output = cross_validate(clf, data.values, y.values, scoring=metrics, cv=rkf,  verbose=2,return_train_score=True)
pd.DataFrame(output).to_csv('output/performanceKNNfull.csv')
